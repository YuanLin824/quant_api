...
export const SYMBOLS_SYNC_CRON = '0 0 8 * * *'

/** 定时任务名称 */
export const SYMBOLS_SYNC_JOB_NAME = 'stock-symbols-sync'

/**
 * 定时任务时区——不可省：容器多为 UTC，
 * 不指定会与北京时间的「早上 8 点」相差 8 小时
 */
export const SYMBOLS_TIMEZONE = 'Asia/Shanghai'
 ...
 */
export const SYMBOLS_UPSERT_CHUNK = 1000
...
export type SymbolMarket = (typeof SYMBOL_MARKETS)[number]
