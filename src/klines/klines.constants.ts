...
export const KLINES_SYNC_CRON = '0 0 16 * * *'

/** 定时任务名称 */
export const KLINES_SYNC_JOB_NAME = 'daily-klines-sync'

/**
 * 定时任务时区——不可省：容器多为 UTC，
 * 不指定会与北京时间的「16:00」相差 8 小时
 */
export const KLINES_TIMEZONE = 'Asia/Shanghai'
 ...
 */
export const KLINES_UPSERT_CHUNK = 1000

/** K 线周期（对应 `KLINE_CATEGORY_MAP` 的键） */
export const KLINES_PERIOD = 'day' as const

/** 全量回补的年数 */
export const KLINES_FULL_YEARS = 2
 ...
 */
export const KLINES_INCREMENTAL_BARS = 5
 ...
 */
export const KLINES_MAX_BARS_PER_REQUEST = 800
 ...
 */
export const KLINES_QUERY_DEFAULT_LIMIT = 240
export const KLINES_QUERY_MAX_LIMIT = 1000
 ...
 */
export const KLINES_QUERY_DEFAULT_START = '1990-07-31'
 ...
 */
export const KLINES_REQUEST_INTERVAL_MS = 1000

/** 失败明细在返回体中最多保留的条数（避免响应体过大） */
export const KLINES_MAX_REPORTED_ERRORS = 20
