...
- **数据维度**：K 线、技术指标、筹码、三大财报、披露日历、资金流向、北向资金持仓、机构评级、一致预期、研报、公告、风险事件、股东、分红、回购、ETF 持仓/净值、宏观经济
...
| 「个股风险明细」（A 股）                                         | `westock risk <代码> [--types ...]`                               | 「哪些股票有某类事件」用 `westock screen event`                         |
...
- ❌ **未知代码禁止凭记忆**：用户给名称未给代码时，**必须先 `westock search` 拿代码**
